      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 z-10">
        <div className="max-w-3xl">
          ...
          <a 
            ...
            className="inline-flex items-center px-8 py-4 text-lg font-medium text-white bg-[#0891b2] rounded-lg hover:bg-[#0e7490] transition duration-300 shadow-lg border-2 border-[#0891b2]"
            style={{ backgroundColor: '#0891b2 !important' }}
          >
